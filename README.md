...
> The MCP server configurations used by [cue](https://github.com/opencue/claude-code-skills). Each profile references servers from this registry by ID.
...
- [cue](https://github.com/opencue/claude-code-skills) — the profile manager that consumes this registry
