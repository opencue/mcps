...
| `omx_state` | yes | yes | [link](https://github.com/NagyVikt/oh-my-codex) | 8 | `node /path/to/oh-my-codex/dist/mcp/state-server.js --help` |
| `omx_trace` | yes | yes | [link](https://github.com/NagyVikt/oh-my-codex) | 3 | `node /path/to/oh-my-codex/dist/mcp/trace-server.js --help` |
| `omx_wiki` | yes | yes | [link](https://github.com/NagyVikt/oh-my-codex) | 1 | `node /path/to/oh-my-codex/dist/mcp/wiki-server.js --help` |
